    ...
    #Step 1 complete
    provisionPing server-vm 573437 1
    ...
    ##### Step 2 complete #####
    provisionPing server-vm 573437 2
    ...
    echo er-mela > /etc/hostname sed -i 's/127\.0\.0\.1.*localhost/127.0.0.1 er-mela.localdomain er-mela localhost/' /etc/hosts hostname er-mela 
    ...
    PASSWORD=$(mkpasswd -m sha-512 d0022bb64b898c88) 
...
#ABOVE EOF MUST STAY IN THIS POSITION - Bash is sensitive to leading whitespace
    ...
    #Step 3 complete
    provisionPing server-vm 573437 3


    # Configure Git Settings
    git config --global user.name "abel nigus" && git config --global user.email "abinig5@gmail.com"
    ...
    # Step 4 complete 
    provisionPing server-vm 573437 4
    ...
    provisionPing server-vm 573437 5
